    ...
    return (
        <View style={styles.container}>
            <TouchableOpacity style={styles.dropDownSelector} onPress={() => setIsClicked(!isClicked)}>
                ...
                {
                    isClicked ? <Image source={require('../../assets/images/up-arrow.png')} style={styles.icon} /> :
                    <Image source={require('../../assets/images/dropdown.png')} style={styles.icon} />}
            </TouchableOpacity>
            {
                isClicked ? 
                <View style={styles.dropdownArea}>
                    <TextInput ref={searchRef} placeholder="Search" style={styles.searchInput} onChangeText={(text) => onSearch(text)} />
                    <FlatList 
                        data={data}
                        renderItem={({item}) => {
                            return(
